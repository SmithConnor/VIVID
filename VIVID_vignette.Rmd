---
title: "VIVID: Visualisation of Variable Importance Differences"
author: "Connor Smith"
...
```{r eval = FALSE}
vivid.sacurine$coefficients
```

### Variance matrix

```{r eval = FALSE}
vivid.sacurine$var_mat
```

### Clustering

```{r eval = FALSE}
vivid.sacurine$var_clust
```
...
```{r eval = FALSE}
vivid.sacurine$compare_method
```

### Comparison values

```{r eval = FALSE}
vivid.sacurine$compare_values
```

### Best feature group (Boolean)

```{r eval = FALSE}
vivid.sacurine$opt_model
```

### Best feature group (Names)

```{r eval = FALSE}
vivid.sacurine$opt_features
```
